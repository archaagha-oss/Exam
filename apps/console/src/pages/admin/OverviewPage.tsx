      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        ...
        <div className="card p-5">
          ...
          <div className="mt-4 flex gap-2 text-xs">
            <Link to="/admin/users" className="text-gray-400 hover:text-white">Manage users →</Link>
            <span className="text-gray-700">·</span>
            <Link to="/admin/users/import" className="text-gray-400 hover:text-white">Bulk import</Link>
          </div>
        </div>
        ...
        <div className="card p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/admin/audit" className="text-xs text-gray-500 hover:text-gray-300">View all →</Link>
          </div>
