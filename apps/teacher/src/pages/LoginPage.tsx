  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (!['TEACHER', 'SCHOOL_ADMIN', 'PLATFORM_ADMIN'].includes(user.role)) {
        setError('This portal is for teachers only.'); return;
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="card p-8">
          <h2 className="text-lg font-semibold mb-1">Teacher Sign In</h2>
          <p className="text-sm text-gray-400 mb-6">Access your exam dashboard</p>
        ...
        <p className="text-center text-xs text-gray-600 mt-4">SecureExam · Teacher Portal</p>
      </div>
    </div>
  );
}
